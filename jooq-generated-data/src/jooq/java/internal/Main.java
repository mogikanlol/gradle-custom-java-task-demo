...
//                .withDirectory(Paths.get(".").toAbsolutePath() + "/build/generated/java")
                .withDirectory(Paths.get(".").toAbsolutePath() + "/src/main/java")
//                .withDirectory(getProject().getProjectDir().getAbsolutePath() + "/src/jooq/java")
                ;
        Strategy strategy = new Strategy()
                .withName("internal.CustomGeneratorStrategy");
